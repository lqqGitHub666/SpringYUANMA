...
class ConstructorResolver {
	...
	public BeanWrapper autowireConstructor(String beanName, RootBeanDefinition mbd,
		...
		//实例一个BeanWrapperImpl对象好理解
		//前面外部返回的BeanWrapper 其实就是一个BeanWrapperImpl
		//因为BeanWrapper 是个接口
		...
		if (constructorToUse == null) {
			...
			if (explicitArgs != null) {
				...
				//实例一个对象，用来存放构造方法的参数值
				//当中主要存放了参数值和阐述之所对应的下标
				ConstructorArgumentValues cargs = mbd.getConstructorArgumentValues();
				resolvedValues = new ConstructorArgumentValues();
				/**
				 * 	确定构造方法参数数量，假设有如下配置：
				 * 		<bean id = "luban" class="com.luban.Luban">
				 * 			<constructor index = "0" value = "str1"></constructor>
				 * 			<constructor index = "1" value = "str2"></constructor>
				 * 			<constructor index = "2" value = "str3"></constructor>
				 * 		</bean>
				 *
				 * 	minNrOfArgs = 3
				 *
			...
			/**
			 * 有访问权限，继而参数个数
			 * 这个自己写个测试去看看到底是不是和我说的一样
			 * 1.public Luban(Object1 o1,Object o2,Object o3)
			 * 2.public Luban(Object1 o1,Object o2)
			 * 3.public Luban(Object1 o1)
			 * 4.protected Luban(Integer i,Object1 o1,Object o2,Object o3)
			 * 5.protected Luban(Integer i,Object1 o1,Object o2)
			 * 6.protected Luban(Integer i,Object1 o1)
			 */
			...
			for (Constructor<?> candidate : candidates) {
				 ...
				 *	首先constructorToUse != null 这个很好理解
				 *	前面已经说过首先constructorToUse 主要是用来装已经解析过了并且在使用
				 *	只有在他等于空的情况下，才有继续的意义，因为下面如果解析到了一个符合
				 *	就会赋值给这个变量（下面有注释）故而如果这个
				 */
