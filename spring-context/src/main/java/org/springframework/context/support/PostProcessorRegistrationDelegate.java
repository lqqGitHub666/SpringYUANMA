...
final class PostProcessorRegistrationDelegate {
	...
	public static void invokeBeanFactoryPostProcessors(
		...
		if (beanFactory instanceof BeanDefinitionRegistry) {
			...
			//存放程序员自己定义的BeanFactoryPostProcessor
			List<BeanFactoryPostProcessor> regularPostProcessors = new ArrayList<>();
			//存放程序员自己定义的BeanDefinitionRegistryPostProcessor
			...
			//currentRegistryProcessors存放spring内部定义的BeanDefinitionRegistryPostProcessor
			...
			//为什么要在最开始注册这个呢？
			//因为spring的工厂需要去解析扫描等功能
			//而这些功能都是需要在spring工厂初始化完成之前执行
			//要么在工厂最开始的时候，要么在工厂初始化之中，反正不能子在之后
			//因为如果在之后就没意义了，因为那个时候需要使用工厂了
			...
			//这里执行的是BeanFactoryPostProcessor的postProcessBeanFactory（）方法
		...
		//执行程序猿用@Component注入的BeanFactoryPostProcessors
	 ...
	 * 便会打印出BeanPostProcessorChecker中设定信息
	 */
